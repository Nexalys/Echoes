...
export function BlogPage({ width = "5.9%", blogTitle = "Blog Title", text = 'This is blog content using *markdown*', rightSidebarOptions = ["Main title", "Main title", "Main title", "Main title", "Main title", "Main title", "Main title", "Main title", "Main title"], username = "Username", date = "12th Jun 2024" }) {
